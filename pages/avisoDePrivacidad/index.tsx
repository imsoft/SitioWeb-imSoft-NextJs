        ...
        <div className="relative px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-indigo max-w-screen-lg mx-auto mt-6 text-gray-500">
            ...
            <p>
              ...
              una petición vía correo electrónico a contacto@imsoft.io y deberá
              contener:
            </p>
            ...
            <p>
              ...
              Ejercitar sus Derechos ARCO, con una descripción clara y precisa
              de los datos a Acceder, Rectificar, Cancelar o bien, Oponerse. En
              caso de Rectificación de datos personales, deberá indicar la
              modificación exacta y anexar la documentación soporte; es
              ...
              alguna obligación legal requiramos seguir tratando sus datos
              personales. Asimismo, usted deberá considerar que para ciertos
              fines, la revocación de su consentimiento implicará que no le
              podamos seguir prestando el servicio que nos solicitó, o la
            ...
            <p>
              ...
              del usuario, Páginas web visitadas por un usuario
            </p>
            <p>
            ...
            <p>Última actualización de este aviso de privacidad: 29/01/2023</p>
          </div>
        </div>
      </div>
    </>
