...
export const Metatags = ({ title, description, keywords, author, subject, date, type, source, image, url }: IMetatags) => {
  return (
    <>
      ...
      <section>
        ...
        <meta property="og:street-address" content="Guadalajara, Jalisco, México" />
